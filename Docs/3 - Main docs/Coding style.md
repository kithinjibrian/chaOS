...
You should especially read about memory management.

## 1. Naming

In most code editors, auto-completion features can assist with longer variable and function names, so it's important to use descriptive names. Descriptive names not only make your code more readable but also simplify tasks like find and replace.
